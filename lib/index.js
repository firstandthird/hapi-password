...
const getCredentials = (password, useCookie) => {
  if (useCookie) {
    return _.find(passwordObject, (o) => o.encryptedPassword === password);
  }
...
const registerStrategy = (server, pluginOptions) => {
...
exports.register = (server, pluginOptions, next) => {
  ...
  registerStrategy(server, pluginOptions);
